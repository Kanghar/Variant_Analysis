...
#tabela_z_wszystkimi_wariatami_other
table_AN <- read.table('table_AN_all_variants_other.csv', sep=',', head=TRUE) 
table_AN_2 <- melt(table_AN, id.vars = 'Chromosom')
names(table_AN_2) <- c('Chromosom','Wariant','AN')
