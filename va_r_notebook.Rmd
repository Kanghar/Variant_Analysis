...
table <- read.table('table_AN_2.csv', sep=',', head=TRUE) #tabela z AN
table2 <- melt(table, id.vars = 'Chromosom')

table_AN_AF <- read.table('table_AF_AN_2.csv', sep='\t', head=FALSE) #tabela z AF_AN - rzadkie warianty < 0.01
...
#przetwarzanie danych dal AF<0.01
